...
public class AdapterGroupUsersDochie extends ArrayAdapter<GroupUserDochie> {
	private int textViewResourceId;

	public AdapterGroupUsersDochie(Context context, int textViewResourceId) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		GroupUserDochie entry = getItem(position);
